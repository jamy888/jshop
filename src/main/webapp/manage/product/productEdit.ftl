				...
				<table class="table table-bordered">
					...
					<tr id="firstTr" style="display:none">
						<td>
								...
								<a href="javascript:void(0);" id="img_del" style="margin-left: 15px; color:#666;" onclick="removeThis(this)"> 删除
					          </a>
						</td>
					</tr>
				</table>
	...
	$(document).ready(function() {
		...
		var url = '${basepath}/common/uploadify.do';
	 	$("#upload").Huploadify({
                ...
                fileSizeLimit: '2048',
                //图片处理页面
                uploader: '${basepath}/common/uploadify.do', 
                'queueID': 'fileQueue',
                //发送给后台的其他参数通过formData指定
                formData: { 'new_name': 'aaaaaaaaaaaaaaaaa' }, //这个是图片的新的命名，要传到。此处直接用aaaaaaaaaaaaaaaaa命名，真正项目肯定要动态命名
